...
# 1. Load all models
# -------------------------
acne_model = tf.keras.models.load_model('ml_service/models/acne_model.h5')
wrinkle_model = tf.keras.models.load_model('ml_service/models/wrinkle.h5')
pigmentation_model = tf.keras.models.load_model('ml_service/models/pigmentation.h5')
skintone_model = tf.keras.models.load_model('ml_service/models/skintone.h5')  # multi-class output
